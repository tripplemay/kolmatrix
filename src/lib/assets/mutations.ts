 ...
 *
 * BL-099-F005: the email_template dual-write was removed. Asset is now
 * the single source of truth (ADR-018); email_log carries a
 * template_name snapshot (F003) so the send + analytics paths no
 * longer reference the email_template mirror, and the table has been
 * dropped.
 */
 ...
 * deleted, false if it never existed (Prisma P2025).
 */
