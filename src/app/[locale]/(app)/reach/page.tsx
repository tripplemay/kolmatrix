...
export default async function OutreachPage({ params, searchParams }: Props) {
  ...
  const composerLabels = {
    ...
    businessUnlockBadge: tComposer("businessUnlockBadge"),
    bioRegexBadge: tComposer("bioRegexBadge"),
    bioRegexTooltip: tComposer("bioRegexTooltip"),
    bioOnlyBanner: tComposer("bioOnlyBanner"),
    ...
    sendProgressTemplate: tComposer.raw("sendProgress") as string,
    sendStillRunning: tComposer("sendStillRunning"),
    batchTooLargeHint: tComposer.raw("batchTooLargeHint") as string,
