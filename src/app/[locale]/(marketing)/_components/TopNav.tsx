...
export async function TopNav({ locale }: Props) {
  ...
  return (
    <nav
      ...
      className="sticky top-0 z-50 border-b border-cyan/10 bg-surface/80 backdrop-blur-xl backdrop-saturate-150"
    >
      <div className="mx-auto flex max-w-6xl items-center justify-between px-6 py-4 lg:px-12">
        ...
        <div className="flex items-center gap-3">
          ...
          <Link
            ...
            className="inline-flex items-center gap-2 rounded-full bg-cyan px-4 py-2 text-sm font-semibold text-surface shadow-[0_0_16px_rgba(0,229,255,0.35)] transition hover:bg-cyan/90"
