...
export function Topbar({ pageTitle, user, unreadNotifications, onSignOut }: TopbarProps) {
  return (
    <header className="bg-navy-base/85 sticky top-0 z-40 flex h-16 items-center gap-6 px-8 shadow-[0_4px_20px_rgba(0,0,0,0.30)] backdrop-blur-[24px]">
      ...
      <TopbarActions user={user} unreadNotifications={unreadNotifications} onSignOut={onSignOut} />
    </header>
  );
}
