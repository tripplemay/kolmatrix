...
- **充值前无法完成全量 L2**——批次可能停在"部署就绪、待充值验真"状态;F006 须明确标注哪些待充值后补验。**[2026-06-06 用户决定]** 充值明天才完成,本批不等:**F006 验收口径解耦充值,本批止于"部署就绪"即可 done**;真实速率验证 + F003 真实投喂 → 全部 deferred 到 **BL-092**(充值后)。
