...
## 🆕 BL-047 修正：closed-not-reproducible → closed-resolved（by BL-021 fix-round 1 @ 9fa2a49 — 真 cross-environment bug 已修）
...
- 5/12 周二：**BL-017 token + BL-046 product soft delete**（独立或合并）
- 5/13 周三 ⭐ 上线对外（5+ day buffer）
## 用户手工待办
...
- 5/7 10:30：测试基建 audit 13 项发现（4-5 day buffer 充足）
- 5/6 19:50/19:55：5+1 决议 X1 合并 + BL-046 治本
## 角色 / Backlog
- 默认映射：CLI=planner+generator，Codex=evaluator
- Backlog 16 条（high 2：BL-017/046；low 5：BL-011/014/015/018/027；closed 1：BL-047；deferred 7）
