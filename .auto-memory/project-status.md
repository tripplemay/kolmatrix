...
1.5. ~~aigcgateway 控制台 UI 设 6 Action max_tokens~~ ❌ **CANCELED 2026-05-06 ~08:30**（用户实地确认 Dashboard UI 无 max_tokens 字段；aigcgateway Action 抽象层根本不绑定此字段；用户 2026-05-06 ~08:30 决议 P3 接受现状不动；治理工作入 BL-042 post-MVP 跟踪）
...
- Backlog 19 条（剩 BL-040+BL-041 PRD 偏差 / BL-042 actions/run max_tokens 治理 post-MVP / BL-012 crawler-sync (post-MVP) / BL-021 Suspense 边界 / BL-022 列表虚拟化 / BL-014/15/16 post-MVP）
