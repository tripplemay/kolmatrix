...
type: project
---
## 🚧 BL-097-crawler-monitor-nav-entry BUILDING (0/2) — 给监控页加网站入口
- F001 UserAvatarMenu admin 段加 /admin/crawler-monitor 链接(仿 apify-preview)+ i18n 5locale + 测试 / F002 Codex. 纯 kolmatrix 小UI(0.5h+0.5h), 不依赖充值/爬虫merge
